...
import { TradingHoursComponent } from 'app/entities/trading-hours/trading-hours.component';
...
describe('Component Tests', () => {
  describe('TradingHours Management Component', () => {
    let comp: TradingHoursComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TradingHoursComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tradingHours && comp.tradingHours[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
