...
import { StaticPagesComponent } from 'app/entities/static-pages/static-pages.component';
...
describe('Component Tests', () => {
  describe('StaticPages Management Component', () => {
    let comp: StaticPagesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StaticPagesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.staticPages && comp.staticPages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
