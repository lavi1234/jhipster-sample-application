...
describe('Service Tests', () => {
  describe('Order Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Order(0, 0, currentDate, 'AAAAAAA', currentDate, currentDate, currentDate, 'AAAAAAA');
    });
        ...
        const returnedFromService = Object.assign(
          {
            ...
            commissionDate: currentDate.format(DATE_FORMAT),
