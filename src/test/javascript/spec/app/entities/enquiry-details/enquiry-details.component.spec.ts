...
import { EnquiryDetailsComponent } from 'app/entities/enquiry-details/enquiry-details.component';
...
describe('Component Tests', () => {
  describe('EnquiryDetails Management Component', () => {
    let comp: EnquiryDetailsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EnquiryDetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.enquiryDetails && comp.enquiryDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
