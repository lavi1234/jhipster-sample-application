...
import { EnquiryComponent } from 'app/entities/enquiry/enquiry.component';
import { EnquiryService } from 'app/entities/enquiry/enquiry.service';
import { Enquiry } from 'app/shared/model/enquiry.model';

describe('Component Tests', () => {
  describe('Enquiry Management Component', () => {
    let comp: EnquiryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EnquiryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.enquiries && comp.enquiries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
