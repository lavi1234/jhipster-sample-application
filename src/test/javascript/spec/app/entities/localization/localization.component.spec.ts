...
import { LocalizationComponent } from 'app/entities/localization/localization.component';
...
describe('Component Tests', () => {
  describe('Localization Management Component', () => {
    let comp: LocalizationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LocalizationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.localizations && comp.localizations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
