...
import { NotificationReceiverComponent } from 'app/entities/notification-receiver/notification-receiver.component';
...
describe('Component Tests', () => {
  describe('NotificationReceiver Management Component', () => {
    let comp: NotificationReceiverComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NotificationReceiverComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new NotificationReceiver(123)],
            headers
          })
        )
      );
      ...
      expect(comp.notificationReceivers && comp.notificationReceivers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
