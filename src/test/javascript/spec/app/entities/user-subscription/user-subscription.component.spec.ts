...
import { UserSubscriptionComponent } from 'app/entities/user-subscription/user-subscription.component';
...
describe('Component Tests', () => {
  describe('UserSubscription Management Component', () => {
    let comp: UserSubscriptionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserSubscriptionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userSubscriptions && comp.userSubscriptions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
