...
export class CartComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.cartService
      ...
      .subscribe(
        (res: HttpResponse<ICart[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInCarts(): void {
    this.eventSubscriber = this.eventManager.subscribe('cartListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICart[] | null, headers: HttpHeaders, page: number): void {
