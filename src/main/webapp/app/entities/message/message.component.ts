...
export class MessageComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.messageService
      ...
      .subscribe(
        (res: HttpResponse<IMessage[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInMessages(): void {
    this.eventSubscriber = this.eventManager.subscribe('messageListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMessage[] | null, headers: HttpHeaders, page: number): void {
